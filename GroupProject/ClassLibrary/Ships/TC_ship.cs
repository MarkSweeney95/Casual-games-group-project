...
{
    public class TC_ship : ClassLibrary.Base.Sprite
    {
        private string ID;
        ...
        public TC_weapon weapon;
        private TC_weapon firedWeapon;

        public TC_ship(string id, Texture2D _tex, float speed) : base(_tex, Vector2.Zero)
        {
            ID = id;
            Health = 100.0f;
            initSpeed = speed;
